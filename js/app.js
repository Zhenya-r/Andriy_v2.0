(() => {
    ...
    function initSliders() {
        if (document.querySelector(".saying-page__slider")) new core(".saying-page__slider", {
            ...
            navigation: {
                prevEl: ".saying-page__arrow_left",
                nextEl: ".saying-page__arrow_right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.08,
    ...
    document.querySelector("[data-fp]");
    const registerForm = document.getElementById("register-form");
    const benefits = document.getElementById("benefits");
    const hotVacancy = document.getElementById("hot-vacancy");
